...
class Block(Base):
    ...
    page_id:Mapped[uuid.UUID] = mapped_column(ForeignKey("journal_pages.id"),nullable=False)
    user_id:Mapped[uuid.UUID] = mapped_column(ForeignKey("users.id"),nullable=False)
    ## Tracking the nested blocks
    parent_id:Mapped[uuid.UUID | None] = mapped_column(ForeignKey("blocks.id"),nullable=True)
    ...
    parent: Mapped["Block | None"] = relationship("Block", remote_side="Block.id", backref="children")
